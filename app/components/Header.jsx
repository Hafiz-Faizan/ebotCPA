...
const financialServices = [
  { name: "Bookkeeping", href: "/financial-reporting?service=Bookkeeping" },
  { name: "Accounting", href: "/financial-reporting?service=Accounting" },
  { name: "Fractional CFO", href: "/financial-reporting?service=Fractional%20CFO" },
];

// Sub-services under Tax
const taxServices = [
  { name: "Tax Planning", href: "/tax?service=Tax%20Planning" },
  { name: "Tax Compliance", href: "/tax?service=Tax%20Compliance" },
  { name: "Tax Resolution", href: "/tax?service=Tax%20Resolution" },
];

// Sub-services under S/4 Finance Implementation
const s4FinanceServices = [
  { name: "Implementations", href: "/s4-finance?service=Implementations" },
  { name: "Central Finance (CFIN)", href: "/s4-finance?service=CFIN" },
  { name: "Support and Training", href: "/s4-finance?service=Support%20and%20Training" },
];
